...
Route::group(['middleware'=>'DisbleBackBtn'], function () {
    Route::group(['middleware'=>'AuthLogin'], function () {
        ...
        Route::controller(AttendanceController::class)->group(function() {
            ...
            Route::get('/notification', [DepositController::class,'notification'])->name('notification');
            Route::get('/deletenotification/{id}', [DepositController::class, 'deletenotification'])->name('deletenotification');
