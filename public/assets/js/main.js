...
$(document).ready(function() {
  $('.sort').on('click', function() {
      ...
      $.ajax({
          url: assignmentListUrl, // Use the variable from the Blade template
          type: "GET",
          data: {
              sort: sort,
              direction: direction
          ...
          success: function(response) {
              // Replace the content of the table's tbody with the response HTML
