                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding:30px; color:#374151;">
                            ...
                            <!-- Leave Details Box -->
                            <div
                                style="background:#fef2f2; border-left:5px solid #dc2626; padding:20px; border-radius:8px; margin:20px 0;">
                    ...
                    <tr>
                        <td
                            style="background:#f9fafb; text-align:center; padding:15px; font-size:12px; color:#6b7280;">
